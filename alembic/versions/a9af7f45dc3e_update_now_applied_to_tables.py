"""update now applied to tables

Revision ID: a9af7f45dc3e
Revises: e7ee74b7b181
Create Date: 2024-10-17 10:21:44.867573
...
def upgrade() -> None:
    ...
    # op.add_column('article', sa.Column('coin_bot_id', sa.Integer(), nullable=False))
    ...
    op.add_column('tokens', sa.Column('updated_at', sa.TIMESTAMP(timezone=True), server_default=sa.text('now()'), nullable=False))
...
def downgrade() -> None:
    ...
    # op.add_column('article', sa.Column('bot_id', sa.INTEGER(), autoincrement=False, nullable=False))
    ...
    # op.create_foreign_key('article_coin_bot_id_fkey', 'article', 'coin_bot', ['bot_id'], ['bot_id'])
    # op.alter_column('article', 'created_at',
    #            existing_type=postgresql.TIMESTAMP(),
    #            nullable=False)
    # op.alter_column('article', 'url',
    ...
    #            existing_type=sa.VARCHAR(),
    #            nullable=False)
    # op.drop_column('article', 'coin_bot_id')
