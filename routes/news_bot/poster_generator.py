...
def generate_poster_prompt(article):
    prompt = f'Generate a visual DALL-E prompt related to this {article}. It should be 400 characters or less and avoid specific names. Focused on abstract image without words'
