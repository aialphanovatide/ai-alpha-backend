        ...
        if date not in ["today", "this week", "last week"]:
            ...
            if not coin_bot:
                ...
                if alerts:
                    ...
                    return {'message': f'No alerts found for {coin} on {date}'}, 404
